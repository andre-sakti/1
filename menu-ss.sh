...
echo -e ""
echo -e "     ${BICyan}[${BIWhite}01${BICyan}] Add Account Sodosok     "
echo -e "     ${BICyan}[${BIWhite}02${BICyan}] Delete Account Sodosok     "
echo -e "     ${BICyan}[${BIWhite}03${BICyan}] Renew Account Sodosok     "
